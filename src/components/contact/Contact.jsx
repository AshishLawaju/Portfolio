...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm("service_47pm739", "template_o64iu8a", fromRef.current, {
        publicKey: "TVLY963g_UATl_QKs",
      })
      .then(
        () => {
          console.log("SUCCESS!");
  ...
  return (
    <motion.div
      className="container flex h-full items-center justify-center gap-[50px] text-white"
      variants={variants}
      initial="initial"
      animate="animate"
    >
      <motion.div className="flex flex-1 flex-col gap-10" variants={variants}>
        ...
        <motion.div>
          <h2>Mail</h2>
          <span className="font-semibold">ashishlawaju@gmail.com</span>
        </motion.div>
        <motion.div>
          <h2>Address</h2>
          <span className="font-semibold">Bhaktapur Nepal</span>
        </motion.div>
        <motion.div>
          <h2 className="font-semibold">Phone</h2>
          <span>+977 9741664337</span>
        </motion.div>
      </motion.div>
      ...
      <div className=" relative flex-1">
        ...
        >
          <input
            className="border border-white bg-transparent p-5"
            type="text"
            required
            placeholder="Name"
            name="name"
          ...
          <textarea
            ...
            className="border border-white bg-transparent p-5"
          ></textarea>
          <button type="submit" className="bg-orange-400  p-[20px] font-medium">
            Submit
          </button>
